    ...
    const handleDragEnd = (result) => {
        ...
        if (type === "column") {
            ...
            if (sourceColumn === destinationColumn) {
                const newJobApplication = Array.from(
                    sourceColumn.jobApplication
                );
                ...
                const sourceJobApplication = Array.from(
                    sourceColumn.jobApplication
                );
                ...
                sourceColumn.jobApplication.map((application) => {
                    if ("jobApplication" + application.id === draggableId) {
                        destinationJobApplication.splice(
                            destination.index,
                            0,
                            application
                        );
            ...
            const applicationStatusId =
                destination.droppableId.split("column")[1];
            // make json data
            const sendData = {
